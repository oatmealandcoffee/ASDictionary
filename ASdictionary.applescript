...
on run {}
	...
	--my standard_burn_test()
	--my big_data_burn_test()
	my duplicate_search_burn_test()
	
end run

(* 
Burn test based on searching for duplicate files in a given directory. 
This was written to test the amount of memory needed to parse through hundreds, if not thousands of items.
*)
...
(* 
Burn test based on the gamut of dictionary options 
This was written to test the amount of memory needed to parse through hundreds, if not thousands of items.
*)
